...
MIDDLEWARE = [
    ...
    # 'account.middleware.TokenBlacklistMiddleware',
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # For signup endpoint
    ]
}
...
ASGI_APPLICATION = 'skin_diseases.asgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'skinwise'
...
# Storage backends
# DEFAULT_FILE_STORAGE = 'skin_diseases.settings.MediaStorage'  # Updated to use custom class
